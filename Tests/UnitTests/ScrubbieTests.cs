...
namespace UnitTests
{
    ...
    public class ScrubbieTests
    {
        ...
        public void SetString_CharTransDict_Matches()
        {
            ...
            string expectedMatchChar = "ŠŒšœŸ¥µÀÁÂÃÄÅÆÇÈÉÊËÌÍÎÏĞÑÒÓÔÕÖØÙÚÛÜİßàáâãäåæçèéêëìíîïğñòóôõöøùúûüıÿ¡¿";
        ...
        public void TestAll()
        {
            ...
            string matchChar = "ŠŒšœŸ¥µÀÁÂÃÄÅÆÇÈÉÊËÌÍÎÏĞÑÒÓÔÕÖØÙÚÛÜİßàáâãäåæçèéêëìíîïğñòóôõöøùúûüıÿ¡¿";
